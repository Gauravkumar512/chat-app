  ...
  new GoogleStrategy(
    ...
    async (_accessToken, _refreshToken, profile, done) => {
      try {
        ...
        const username = (verifiedEmail.split('@')[0] ?? verifiedEmail).toLowerCase().replace(/[^a-z0-9_-]/g, '');
  ...
  new GitHubStrategy(
    ...
    async (
      ...
      try {
        ...
        const username = (profile.username || email.split('@')[0]).toLowerCase().replace(/[^a-z0-9_-]/g, '');
